...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Product_parameter {{ $product_parameter->id }}</div>
                    <div class="card-body">

                        <a href="{{ url('/admin/product_parameter') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $product_parameter->id }}</td>
                                    </tr>
                                    <tr><th> Product Parameter </th><td> {{ $product_parameter->product_parameter }} </td></tr><tr><th> Product Id </th><td> {{ $product_parameter->product_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
